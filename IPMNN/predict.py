...
if __name__ == "__main__":
    ...
    # 加载各个区域的坐标数据
    # TIME_STR = '20220910_224427'
    # TIME_STR = '20220910_224431'
    # TIME_STR = '20220910_224438'
    # TIME_STR = '20220910_224443'

    
    # TIME_STR = '20230227_212427'
    # TIME_STR = '20230227_212435'
    # TIME_STR = '20230227_212440'
    # TIME_STR = '20230227_212446'


    # TIME_STR = '20231130_101835'
    TIME_STR = '20231130_103235'
    # TIME_STR = '20231130_104648'
    # TIME_STR = '20231130_111033'
    ...
    negative = 1
    if model_config.lambda_ < 0:
        negative = -1
    u_pred = negative * u_pred/torch.norm(u_pred, p=2)
    ...
    L_infinity_rel_lambda = L_infinity_lambda/lambda_
    L_2_lambda = (lambda_-model_config.lambda_)**2
    log_str = 'lambda ' + str(model_config.lambda_) +\
        ' L_infinity_lambda '+str(L_infinity_lambda) +' L_2_lambda '+str(L_2_lambda) +' L_infinity_rel_lambda '+str(L_infinity_rel_lambda) +\
        ' L_infinity_u ' + str(L_infinity_u) + ' L_2_u ' + str(L_2_u)
    log(log_str)


    if d==1:
        file_name = root_path + '/' + TASK_NAME + '/' + TIME_STR + '/ipm_line'
        datas = []
    ...
    if d==2:
        ...
        file_name = root_path + '/' + TASK_NAME + '/' + TIME_STR + '/ipm_heatmap3'
    ...
    # y=stats.norm.pdf(u_true)#连续分布用pdf,离散分布用pmf
    file_name = root_path + '/' + TASK_NAME + '/' + TIME_STR + '/ipm_density_' + str(d)
